            ...
            <form onSubmit={edit}>
                ...
                <div className="form-group row">
                    ...
                    <div className="col-sm-7">
                        <input type="password" placeholder="Password old" minLength="6" className="form-control"
                ...
                <div className="form-group row">
                    ...
                    <div className="col-sm-7">
                        <input type="password" placeholder="Password new" minLength="6" className="form-control"
